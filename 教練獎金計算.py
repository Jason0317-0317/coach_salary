...
def generate_perfect_salary_report(uploaded_files):
    ...
    cols_triple = [
    "教練", "課程", "單價", "義昌館堂數", "義昌館金額", "高美館堂數", "高美館金額", 
    "中山館堂數", "中山館金額", "三館總堂數", "三館總金額", "應付金額(三館)", 
    "總計(三館)", "執行業務(扣款)", "補充保費(扣款)", "應付薪資(三館)", "年資"
    ]
    cols_egg = [
    "教練", "課程", "單價", "巨蛋館堂數", "巨蛋館金額", "三館總堂數", 
    "三館總金額", "應付金額", "總計", "執行業務(扣款)", 
    "補充保費(扣款)", "應付薪資"
    columns = [
        "教練", "課程", "單價", "義昌館堂數", "義昌館金額", "高美館堂數", "高美館金額", "中山館堂數", "中山館金額", "三館總堂數", "三館總金額", "應付金額", "堂數達標獎金(加項)", "總計", "執行業務(扣款)", "補充保費(扣款)", "應付薪資", "年資"
    ]
